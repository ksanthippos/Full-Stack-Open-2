...
const typeDefs = gql`
  ...
  type Query {
    bookCount: Int!
    authorCount: Int!
    allBooks(author: String, genre: String, username: String): [Book]!
    allAuthors: [Author]!
    me: User
  }
  type Mutation {
  ...
  Query: {
    ...
    allBooks: async (root, args) => {
      ...
      if (args.username) {
        ...
        books = await Book.find({ genres: user.favoriteGenre }).populate('author')
      }
      ...
      if (!args.genre && !args.author && !args.username) {
